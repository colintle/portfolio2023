  ...
  return (
    <div ref={ref} className={`${inView ? "animate__animated animate__fadeIn animate__slow" : "opacity-0"} min-h-screen flex justify-center bg-white`}>
        <div className='w-3/4 md:w-1/2 flex flex-col'>
            ...
            <div className='text-md lg:text-lg xl:text-xl flex flex-col flex-grow justify-evenly'>
                <p className=''>I am a rising Senior at the University of Central Florida, double majoring in Computer Science and Statistics. My interest in coding started in high school when I first saw <i>The Social Network</i> directed by David Fincher.</p>
                <p className=''>Jumping to present day, I have had the opportunity as a Software Engineer Intern to gain valuable experience and contribute to the development of software products at several different organizations including
                    <strong className='text-transparent bg-clip-text bg-gradient-to-b from-sky-600 to-purple-700'> Microsoft</strong>, 
