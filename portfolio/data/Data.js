export const PROJECTS = [{
    ...
    description:
      "In 24 hours, we developed a web app for Tarrant To & Through Partnership (T3) to provide the ultimate experience for the student and family to be more educated about the possibility of pursuing higher-level education. A student and family may fill out a survey to display personalized information of schools and scholarships or chat with T3acherBot, our chatting bot, to answer any questions/concerns.",
  ...
  },
  {
    ...
    description:
      "Using the Spotify API, this app allows the user to generate playlists with a click of a button. Check it out!",
